      ...
      <div className="max-w-7xl mx-auto p-5 lg:p-0 items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-40 items-center">
          <div className="">
            ...
            <a
              href="#"
              className="inline-flex pl-5  rounded-full border-1 border-[#F48C06] text-[#F48C06] text-xl items-center"
            >
              Write your assessment<div className="ml-5 w-16 h-16 rounded-full border-1 border-[#F48C06] p-3  hover:-rotate-20"><HiArrowLongRight className="text-4xl" /></div>
            </a>
          </div>
          <img src={test} alt="" />
        </div>
