  ...
  return (
    <div className="py-10">
      <div className="max-w-7xl mx-auto p-5 lg:p-0 text-center">
        ...
        <p className="text-lg text-[#696984] mb-20">
          Skilline is one powerful online software suite that combines all the
          tools needed to run a successful school or office.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-15">
          <div className="p-13 rounded-3xl shadow-lg group hover:-translate-y-10 transition-all duration-150 ease-in hover:shadow-2xl hover:shadow-[#abaefc]">
            <div className="flex justify-center group-hover:scale-[1.1] transition-all duration-100 group-hover:animate-(--animate-rotateX)"><img src={icon01} alt="" /></div>
          ...
          <div className="p-13 rounded-3xl shadow-lg group hover:-translate-y-10 transition-all duration-150 ease-in hover:shadow-2xl hover:shadow-[#ffd3a0]">
            <div className="flex justify-center group-hover:scale-[1.1] transition-all duration-100 group-hover:animate-(--animate-rotateX)"><img src={icon02} alt="" /></div>
          ...
          <div className="p-13 rounded-3xl shadow-lg group hover:-translate-y-10 transition-all duration-150 ease-in hover:shadow-2xl hover:shadow-[#abf7fc]">
            <div className="flex justify-center group-hover:scale-[1.1] transition-all duration-100 group-hover:animate-(--animate-rotateX)"><img src={icon03} alt="" /></div>
